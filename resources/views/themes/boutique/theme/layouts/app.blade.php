...
<body
    class="bg-stone-50 text-stone-900 antialiased min-h-screen flex flex-col"
...
>
    ...
    @if (session('cart_success'))
        <div
            ...
            x-transition
            class="fixed top-20 right-4 z-50 bg-stone-900 text-stone-50 text-sm px-4 py-3 rounded-lg shadow-lg max-w-xs"
        >
