    ...
    <div>
        ...
        @if ($orders->isEmpty())
            <div class="bg-white border border-gray-200 rounded-xl p-12 text-center">
                ...
                <a href="{{ route('collections.show', 'all') }}" class="mt-4 inline-block bg-gray-900 text-white text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-gray-700 transition-colors">
                    Mulai belanja
                </a>
            </div>
        @else
