        ...
        <form method="POST" action="{{ route('checkout.process') }}"
            ...
            <div class="lg:grid lg:grid-cols-5 lg:gap-12">
                ...
                <div class="lg:col-span-3 flex flex-col gap-6">
                    ...
                    <button type="submit"
                            :disabled="loading"
                            class="w-full theme-btn-primary font-semibold py-4 rounded-xl transition-colors text-sm disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2">
